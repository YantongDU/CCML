    ...
    def build(self):
        ...
        if split_mode == 'RS':
            ...
            if group_by is None or group_by.lower() == 'none':
                ...
                datasets = self.split_by_ratio_meta(split_args['RS'], group_by=self.uid_field, train_set_ratio=train_set_ratio)
            else:
        ...
        return datasets
    def split_by_ratio_meta(self, ratios, group_by, train_set_ratio=None):
        '''
