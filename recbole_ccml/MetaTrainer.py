...
class MetaTrainer(Trainer):
    ...
    def evaluate(self, eval_data, load_best_model=True, model_file=None, show_progress=False, checkpoint=None):
        '''
        ...
        if load_best_model:
            if checkpoint is None:
                checkpoint_file, checkpoint = self.load_best_checkpoint()
